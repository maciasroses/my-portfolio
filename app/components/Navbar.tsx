...
const Navbar = () => {
  ...
  return (
    <header
      className={`z-40 w-full fixed backdrop-blur bg-white/80 drop-shadow-2xl dark:text-white dark:bg-[#202124FF]/80 animate-fade animate-duration-[2000ms] animate-delay-[4000ms] duration-300 ease-in-out ${
